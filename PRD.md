...
* **Outputs**:
  ...
  4. **Counterfactual rollouts**r scenario knobs (rain/heat)
...
* Convert to anomal a^\text{rain}*t = \frac{P_t - \mu*{month}}{\sigma_{month} + \epsilon}
  ]
...
* Rain anomaly should change water/veg outcomes plausibly (sanity), not cBacktesting on known “big build” regions
...
* “World model learns d flags persistent deviations; counterfactual rollouts provide scenario-based baselines that reduce false alarms.”
